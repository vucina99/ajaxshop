            ...
            <div class="container-fluid">
                <div class="row ">
                    ...
                    <div class="col-1 pt-3 text-dark border-left border-right  d-flex align-items-center justify-content-right justify-content-center">
                        <div class=""><button onclick='removeFromCart(${p.id})' class="btn btn-dark">X</button> </div>
...
function showEmptyCart() {
  ...
  let html = `<ul class="list-group">
            ...
            <li class="list-group-item text-center  text-dark">
                ...
                <h4>KORPA JE PRAZNA - <a href="index.html"><button class="btn btn-outline-dark">PRONADJI PATIKE</button> </a></h4>
